    ...
    >
      ...
      >
        ...
        >
          <div
            className="dot red"
            style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#ff5f56' }}
          ></div>
          <div
            className="dot yellow"
            style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#ffbd2e' }}
          ></div>
          <div
            className="dot green"
            style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#27c93f' }}
          ></div>
        ...
        >
          <div className="terminal-line">
            <span className="prompt" style={{ color: 'var(--accent-color)' }}>
              nova@glass
            </span>
            :
