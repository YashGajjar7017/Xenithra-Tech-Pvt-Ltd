      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              {themes.map((t) => (
                <option key={t.id} value={t.id} style={{ background: '#161b22', color: '#fff' }}>
                  {t.name}
                </option>
              ))}
            </select>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>
                Automatically save file edits on focus loss
              </div>
            </div>
            <input
              type="checkbox"
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                <option value="2" style={{ background: '#161b22', color: '#fff' }}>
                  2 Spaces
                </option>
                <option value="4" style={{ background: '#161b22', color: '#fff' }}>
                  4 Spaces
                </option>
              </select>
            </div>
          ...
          >
            <div>
              ...
              <div style={{ fontSize: '10px', color: 'var(--text-muted)' }}>
                Display line numbers column in editor
              </div>
            </div>
            <input
              type="checkbox"
