      ...
      >
            ...
            <tbody>
              {filteredShortcuts.map((s, idx) => (
                ...
                >
                  ...
                  <td style={{ color: '#8b949e', fontFamily: 'monospace', fontSize: '10px' }}>
                    {s.when}
                  </td>
        ...
        {editingCommand && (
          ...
          >
            ...
            >
              <div style={{ fontSize: '13px', fontWeight: 'bold', color: '#58a6ff' }}>
                Rebind Keybinding
              </div>
              <div style={{ fontSize: '11px', color: '#c9d1d9' }}>
                Command: <b>{editingCommand.command}</b>
              </div>
              ...
              <div style={{ fontSize: '10px', color: '#8b949e', textAlign: 'center' }}>
                Press keys on keyboard, then click Save
              </div>
