    ...
    >
      ...
      {showCloneModal && (
        ...
        >
          ...
          {cloneStatus && (
            <div style={{ fontSize: '10px', color: '#58a6ff', marginTop: '6px' }}>
              {cloneStatus}
            </div>
          )}
        </div>
        ...
        <React.Fragment>
          ...
          {diffContent && (
            ...
            >
              ...
              >
                <span style={{ fontSize: '10px', fontWeight: 'bold', color: '#58a6ff' }}>
                  DIFF: {diffContent.file}
                </span>
                <span
          ...
          <div>
            ...
            {gitData.commitLogs &&
              gitData.commitLogs.map((log, idx) => (
                <div
                  key={idx}
                ...
                >
                  ...
                  <div style={{ color: '#c9d1d9', fontSize: '11px', marginTop: '2px' }}>
                    {log.message}
                  </div>
                </div>
              ))}
